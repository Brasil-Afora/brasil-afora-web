...
interface OpportunityConfirmationPopupProps {
  onCancel: () => void
  onConfirm: () => void
  opportunity: Opportunity | null
}

const OpportunityConfirmationPopup = ({
  opportunity,
  onConfirm,
  onCancel,
}: OpportunityConfirmationPopupProps) => {
  if (!opportunity) {
    return null
  }
...
export default OpportunityConfirmationPopup
