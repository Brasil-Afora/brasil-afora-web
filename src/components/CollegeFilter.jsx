...
const CollegeFilter = ({ filtros, setFiltros, onClearFilters }) => {
    ...
    const handleInputChange = (e) => {
        ...
        // MODIFIED: Rename faixaSAT and faixaACT to notaSAT and notaACT
        ...
        <div className={commonWidth}>
            ...
            <div className={`relative ${commonWidth}`}>
                <input
                    ...
                    type="text"
                    value={placeholder}
                    className={`${inputClasses} ${commonWidth} cursor-pointer`}
                    readOnly
                    onClick={onToggle}
                />
                {isOpen && (
    ...
    return (
        <div ref={filterRef}>
            <div className="w-full relative flex flex-col gap-1 font-inter">
                <div className={commonWidth}>
                    <label htmlFor="nome" className="block text-sm text-white mb-1">
                        <span className="text-amber-500">Nome da Faculdade</span>
                    </label>
                    <input
                        id="nome"
                        type="text"
                ...
                {/* MODIFIED: Changed label and placeholder to reflect single score input */}
                <div className={commonWidth}>
